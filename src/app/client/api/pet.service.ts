...
export class PetService {
     ...
     * add pet
     * 
     * @param body The pet details
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public addPet(body?: Pet, observe?: 'body', reportProgress?: boolean): Observable<string>;
    public addPet(body?: Pet, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public addPet(body?: Pet, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
